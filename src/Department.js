...
export class Department extends Component {
  ...
  createClick() {
    fetch(variables.API_URL + "Department/" + "add", {
      method: "POST",
      headers: {
      ...
      .then(
        (result) => {
          alert("Successfully added new departments");
  ...
  updateClick() {
    fetch(variables.API_URL + "Department/edit", {
      method: "PUT",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
            ...
            {this.state.departments.map((dep) => (
              <tr key={dep.DepartmentID}>
                ...
                <td>
                  <button
                    type="button"
                    className="btn btn-light bg-info mr-1"
                    data-bs-toggle="modal"
                    data-bs-target="#exampleModal"
